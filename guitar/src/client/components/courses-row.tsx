...
function CourseCard({
  ...
  return (
    <button
      ...
      style={style}
      className={cn(
        'guitar-card-tone group relative isolate flex h-36 cursor-pointer flex-col overflow-hidden rounded-2xl text-left',
    ...
    >
      <div className="relative z-10 flex flex-1 flex-col gap-1 p-4">
        ...
        <h3 className="guitar-serif text-foreground line-clamp-1 text-xl font-semibold leading-tight tracking-tight">
          {course.title}
        </h3>
