...
export function CourseView({
  ...
  return (
    <div className="animate-piano-view-forward relative flex h-full min-h-0 flex-col overflow-hidden">
      <div className="piano-no-scrollbar min-h-0 flex-1 overflow-y-auto">
        ...
        >
          ...
          <section className="mb-8">
            ...
            <h1 className="piano-serif text-foreground mt-2 text-4xl font-semibold leading-tight tracking-tight">
              {course.title}
            </h1>
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <div className="flex min-w-0 flex-1 items-center gap-3">
                ...
                <span className="text-muted-foreground piano-mono shrink-0 text-[11px] tabular-nums">
                        ...
                        >
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2">
                              <span className="text-muted-foreground/70 piano-mono shrink-0 text-[12px] tabular-nums leading-none">
                                {idx + 1}.
                              </span>
                              <span
                                className={cn(
                                  'piano-serif text-foreground translate-y-[1px] truncate text-[15px] font-semibold leading-none tracking-tight',
                          ...
                          <span
                            className={cn(
                              'piano-mono shrink-0 text-[10.5px] uppercase tracking-wider opacity-0 transition-opacity group-hover/lesson:opacity-100',
      ...
      <AlertDialog open={confirmReset} onOpenChange={setConfirmReset}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="piano-serif text-lg">
