 ...
 *
 * The builder converts them to PianoNote objects and assembles a full
 * PianoSong with all required metadata. Each tutorial uses 60 BPM so
...
export function buildNotes(phrase: Phrase): PianoNote[] {
...
export function buildTutorialSong(raw: RawTutorial): PianoSong {
